...
| **B4** | Default Claude startup injection MUST exclude `dangerous_permission_enter` (explicit policy may opt in). Startup injection stays **Claude-only** — no blank Enter / startup lines on Codex/Hermes/OpenClaw panes. | startup-injection / launcher refactors | S:2026-05-20_0108; S:2026-05-19_2229; LRN-20260508-003 | `test/launch-agent-runtime.test.sh` |
