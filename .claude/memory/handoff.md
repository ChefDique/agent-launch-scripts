...
**State at last pause (2026-05-05T13:41:56-0700):**
...
- Shipped `6de1a43` after live review: the first pass left existing fleet entries on `runtime: "claude"`; this session killed the respawning `rnd`/Lucius Claude process, changed all local fleet entries to Codex, defaulted missing runtime to Codex, and added regression tests that fail unapproved Claude runtime entries.
